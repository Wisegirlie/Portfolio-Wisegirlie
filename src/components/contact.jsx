                    ...
                    <div className="contact_container">
                        ...
                        <div className="contact_form_div gris_back"> 
                            ...
                            <form action="/" className="form_container">
                                ...
                                <input type="text" name="name" id="name" className="form_input" required/>  <br />
                                <label htmlFor="email">E-mail:</label>
                                <input type="email" name="email" id="email" className="form_input" required/> <br />
                                <label htmlFor="number">Contact number:</label>
                                <input type="text" name="number" id="number" className="form_input"/>  <br />
                                <label htmlFor="message">Your message:</label>
                                <textarea name="message" id="message" rows="7" required></textarea><br />
